# Watch: Daily Source Intelligence
...
- 纯营销、无技术细节的融资稿。
- 初级教程、泛泛的 prompt tips。
- 没有原始链接的转载。
- 无法确认日期或来源的社交媒体截图。
- 与 AI、独立开发、产品增长、工程 infra 都无关的 Apple 评论、泛前端随笔、写作/元数据来源。

## 输出偏好

- 中文总结，英文术语、账号、repo、API 名保持原文。
- 先给结论，再给证据。
- 区分官方原文、直接 X 链接、二手转述和待验证线索。
- 不为了凑数量保留低质量内容。
